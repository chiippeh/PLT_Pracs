...
public class Scanner {
	...
	static final int barbar_Sym = 29;
	static final int andand_Sym = 30;
	static final int plus_Sym = 31;
	static final int minus_Sym = 32;
	static final int bang_Sym = 33;
	static final int new_Sym = 34;
	static final int star_Sym = 35;
	static final int slash_Sym = 36;
	static final int percent_Sym = 37;
	static final int equalequal_Sym = 38;
	static final int bangequal_Sym = 39;
	static final int equal_Sym = 40;
	static final int lessgreater_Sym = 41;
	static final int less_Sym = 42;
	static final int lessequal_Sym = 43;
	static final int greater_Sym = 44;
	static final int greaterequal_Sym = 45;
	static final int colonequal_Sym = 46;
	static final int NOT_SYM = 47;
	// pragmas
	static final int DebugOn_Sym = 48;
	static final int DebugOff_Sym = 49;
	static final int ProdCODOn_Sym = 50;
	static final int ProdCODOff_Sym = 51;
	static final int PrintSymbolTable_Sym = 52;
	static final int PrintRuntimeStack_Sym = 53;
	static final int PrintRuntimeHeap_Sym = 54;
	...
	static Token NextToken() {
		...
		while (!done) {
			switch (state) {
				...
				case 13:
					{ t.kind = ProdCODOn_Sym; done = true; break; }
				case 14:
					{ t.kind = ProdCODOff_Sym; done = true; break; }
				case 15:
					{ t.kind = PrintSymbolTable_Sym; done = true; break; }
				case 16:
					{ t.kind = PrintRuntimeStack_Sym; done = true; break; }
				case 17:
					if (ch == 'D') { buf.append(ch); NextCh(); state = 18; break;}
					else { t.kind = noSym; done = true; break; }
				case 18:
					{ t.kind = PrintRuntimeHeap_Sym; done = true; break; }
				case 19:
					if (ch == 'D') { buf.append(ch); NextCh(); state = 20; break;}
					else if (ch == 'C') { buf.append(ch); NextCh(); state = 21; break;}
